...
class DatestampTestCase(TestCase):
    def test_strict_datestamp_to_datetime(self):
        ...
        self.assertEqual(datetime(2005, 7, 4), datestamp_to_datetime("2005-07-04"))
    ...
    def test_tolerant_datestamp_to_datetime(self):
        ...
        self.assertEqual(datetime(2005, 7, 4, 14, 35, 10), f("2005-07-04T14:35:10Z"))
        self.assertEqual(datetime(2005, 1, 24, 14, 34, 2), f("2005-01-24T14:34:02Z"))
        self.assertEqual(datetime(2005, 7, 4), f("2005-07-04"))
        self.assertEqual(datetime(2005, 1, 1), f("2005"))
        self.assertEqual(datetime(2005, 2, 1), f("2005-02"))
